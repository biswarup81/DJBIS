	...
	<div class="container">
		...
		<div class="row pt-5">
			...
			<div class="col-md-6 col-lg-4 mb-4">
				<img class="light-mode-item" src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/logo.svg" alt="logo">			
				<img class="dark-mode-item" src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/logo-light.svg" alt="logo">
