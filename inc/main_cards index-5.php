    ...
    <div class="row g-4">
        ...
        <div class="card card-overlay-bottom card-img-scale overflow-hidden">
          ...
          <div class="card-img-overlay d-flex flex-column p-3 p-md-4"> 
            ...
            <div class="w-100 mt-auto">
              ...
              <!-- Card title -->
              <h4 class="text-white"><a href="post-single-5.html" class="btn-link text-reset stretched-link">Best Pinterest boards for learning about business</a></h4>
              <!-- Card info -->
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="card card-overlay-bottom card-image-scale">
          <!-- Card Image -->
          <img src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/blog/3by4/02.jpg" alt="">
          <!-- Card Image overlay -->
          <div class="card-img-overlay d-flex flex-column p-3 p-md-4"> 
            <div>
              <!-- Card category -->
            ...
            <div class="w-100 mt-auto">
              <!-- Card title -->
              <h4 class="text-white"><a href="post-single-5.html" class="btn-link text-reset stretched-link">5 intermediate guide to business</a></h4>
              <!-- Card info -->
              <ul class="nav nav-divider text-white-force align-items-center small">
                <li class="nav-item position-relative">
      ...
      <div class="col-12 col-lg-4">
        <div class="card card-overlay-bottom bg-parallax h-400 h-lg-100" data-jarallax-video="https://youtu.be/WS-MfCjzztg" data-speed="1.2">
          ...
          <div class="card-img-overlay d-flex flex-column p-3 p-md-4">
            ...
            <div class="w-100 mt-auto">
              <!-- Card title -->
              <h4 class="text-white"><a href="post-single-5.html" class="btn-link text-reset stretched-link">5 investment doubts you should clarify</a></h4>
              <!-- Card info -->
              <ul class="nav nav-divider text-white-force align-items-center small">
                <li class="nav-item position-relative">
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="card card-overlay-bottom card-image-scale">
          <!-- Card Image -->
          <img src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/blog/3by4/04.jpg" alt="">
          <!-- Card Image overlay -->
          <div class="card-img-overlay d-flex flex-column p-3 p-md-4">
            <div>
              <!-- Card category -->
            ...
            <div class="w-100 mt-auto">
              <!-- Card title -->
              <h4 class="text-white"><a href="post-single-5.html" class="btn-link text-reset stretched-link">7 common mistakes everyone makes while traveling</a></h4>
              <!-- Card info -->
              <ul class="nav nav-divider text-white-force align-items-center small">
                <li class="nav-item position-relative">
                  <div class="nav-link">by <a href="#" class="stretched-link text-reset btn-link">Bryan</a>
                ...
                <li class="nav-item position-relative">
                  <div class="d-flex align-items-center position-relative">
                    <div class="avatar avatar-xs">
                      <img class="avatar-img rounded-circle" src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/avatar/01.jpg" alt="avatar">
                    </div>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="card card-overlay-bottom card-image-scale">
          <!-- Card Image -->
          <img src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/blog/3by4/05.jpg" alt="">
          <!-- Card Image overlay -->
          <div class="card-img-overlay d-flex flex-column p-3 p-md-4"> 
            <div>
              <!-- Card category -->
            ...
            <div class="w-100 mt-auto">
              <!-- Card title -->
              <h4 class="text-white"><a href="post-single-5.html" class="btn-link text-reset stretched-link">Bad habits that people in the industry need to quit</a></h4>
              <!-- Card info -->
              <ul class="nav nav-divider text-white-force align-items-center small">
                <li class="nav-item position-relative">
            ...
            <div class="w-100 mt-auto">
              ...
              <ul class="nav nav-divider align-items-center small">
                <li class="nav-item position-relative">
                  <div class="d-flex align-items-center position-relative">
                    <div class="avatar avatar-xs">
                      <img class="avatar-img rounded-circle" src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/avatar/05.jpg" alt="avatar">
                    </div>
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="card card-overlay-bottom card-image-scale">
          <!-- Card Image -->
          <img src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/blog/3by4/06.jpg" alt="">
          <!-- Card Image overlay -->
          <div class="card-img-overlay d-flex flex-column p-3 p-md-4">
            <div>
              <!-- Card category -->
      ...
      <div class="col-sm-6 col-lg-4">
        <div class="card card-overlay-bottom card-image-scale">
          <!-- Card Image -->
          <img src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/blog/3by4/07.jpg" alt="">
          <!-- Card Image overlay -->
          <div class="card-img-overlay d-flex flex-column p-3 p-md-4"> 
            <div>
              <!-- Card category -->
            ...
            <div class="w-100 mt-auto">
              <!-- Card title -->
              <h4 class="text-white"><a href="post-single-5.html" class="btn-link text-reset stretched-link">Ten questions you should answer truthfully.</a></h4>
              <!-- Card info -->
              <ul class="nav nav-divider text-white-force align-items-center small">
                <li class="nav-item position-relative">
                  <div class="nav-link">by <a href="#" class="stretched-link text-reset btn-link">Billy</a>
