	...
	<nav class="navbar navbar-expand-lg">
		<div class="container">
			...
			<a class="navbar-brand" href="index.html">
				<img class="navbar-brand-item light-mode-item" src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/logo.svg" alt="logo">			
				<img class="navbar-brand-item dark-mode-item" src="https://djbis.s3.ap-south-1.amazonaws.com/assets/images/logo-light.svg" alt="logo">			
			</a>
			<!-- Logo END -->
